...
export const aragornData = {
  ...
  deeds: [
    {
      place: 'Bree',
      quoteId: ['5cd96e05de30eff6ebccf0db'],
      deed: [
      ...
      images: [
        IMAGES.Strider,
        IMAGES.AragornSpeaksOnNazgul,
        IMAGES.AragornLeadsHobbits
      ]
    },
    {
      place: 'Weathertop',
      quoteId: ['5cd96e05de30eff6ebccee85'],
      deed: [
      ...
      images: [
        ...
        IMAGES.AragornAtWeathertop,
        IMAGES.AragornSpeaksToHobbits
      ]
    },
    {
      place: 'Rivendell',
      quoteId: ['5cd96e05de30eff6ebcceee2'],
      deed: [
